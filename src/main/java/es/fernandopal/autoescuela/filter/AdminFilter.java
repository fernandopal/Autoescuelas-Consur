...
@WebFilter(filterName = "TestsFilter", urlPatterns = {"/admin/*", "/app/a/*"}, dispatcherTypes = {DispatcherType.REQUEST})
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) {
        ...
        if (!loggedInUser) {
            ...
            Util.sendMessage("403", "/home", labels.get("NEED_ADMIN_PERMISSION", session), httpRequest, httpResponse);
            return;
        }
