                ...
                add.on('click', function(event) {
                    ...
                    if(count <= 10) {
                        listContainer.append(
                            ...
                            '<input class="form-control mt-1" type="text" placeholder="Categoría (Mecánica, Señales...)" name="p'+count+'c" required>' +
                            '<input class="form-control mt-1" type="text" placeholder="Respuesta 1 (correcta)" name="p'+count+'r1" required>' +
                            '<input class="form-control mt-1" type="text" placeholder="Respuesta 2" name="p'+count+'r2" required>' +
                            '<input class="form-control mt-1" type="text" placeholder="Respuesta 3" name="p'+count+'r3" required>' +
                            '<input class="form-control mt-1" type="text" placeholder="Respuesta 4" name="p'+count+'r4" required>' +
                            '</div>'
                        );
